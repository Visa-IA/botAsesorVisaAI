...
// const { welcomeflow } = require('./src/flows/welcome.flow'); // Importa el flujo de bienvenida
const { flowPrincipal } = require('./src/flows/principal.flow'); // Importa el flujo principal

const PORT = process.env.PORT ?? 3001;

const ARREGLO_DE_FLOWS = [ flowPrincipal]
...
const main = async () => {
    ...
    const adapterFlow = createFlow(ARREGLO_DE_FLOWS)
